...
async fn main(spawner: Spawner) {
    ...
    let pins = Pins {
        ...
        // the board.
        brightness: peripherals.P0_03.degrade_saadc(),
        ...
        // TODO: Use a different pin to free up this pin for the on-board LEDs.
        // GPIO port 0 pin 31 is an analog input corresponding to pin 3 on the board.
        delay: peripherals.P0_31.degrade_saadc(),
